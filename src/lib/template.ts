/**
 * Base HTML template for the pitch page. Matches sample structure exactly.
 * Only placeholders are replaced. Sponsorship and footer sections are fixed.
 */

export function getPitchHtml(values: {
  companyName: string;
  roleName: string;
